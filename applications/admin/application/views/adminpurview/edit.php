                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal m-t" id="purviewForm" novalidate="novalidate" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="url" name="url" class="form-control"value="<?php echo $info['url'];?>" aria-required="true" aria-invalid="true">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">权限名称：</label>
                                    <div class="col-sm-8">
                                        <input type="text" id="name" name="name" value="<?php echo $info['name'];?>"  class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group">
