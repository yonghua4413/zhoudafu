                ...
                <div class="table-responsive ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input name="place1" minlength="2" type="text" class="form-control" valType="required" msg="地点1不能为空" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">地点2：</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="place2" valType="required" msg="地点2不能为空"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">线路说明：</label>
                            <div class="col-sm-3">
                                <textarea id="ccomment" name="explain" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
