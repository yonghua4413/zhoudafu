                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal m-t" id="signupForm" novalidate="novalidate" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="fullname" name="fullname" class="form-control" type="text" aria-required="true" aria-invalid="false">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">电子邮箱：</label>
                                    <div class="col-sm-8">
                                        <input id="email" name="email" class="form-control" type="email" aria-required="false">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input  name="describe" class="form-control" type="email">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="radio" checked="" value="1" id="yes" name="disabled">正常</label>
                                        
                                        <label class="radio-inline" for="no">
                                        <input type="radio" value="2" id="no" name="disabled">禁用</label>
                                    </div>
                                </div>
