<?php $this->load->view('common/public_top');?>
            ...
            <div class="table-responsive ibox-content">
                <p><a href="/config/jok_add" class="btn btn-w-m btn-primary">添加段子</a></p>
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td class="col-sm-2">
                            <a href="/config/jok_modify?id=<?php echo $v['id']?>" class="btn btn-outline btn-primary">修改</a>
                            <a href ="/config/jok_del?id=<?php echo $v['id']?>" class="btn btn-outline btn-danger">删除</a>
                        </td>
                    </tr>
                    <?php endforeach;?>
                    <?php endif;?>
