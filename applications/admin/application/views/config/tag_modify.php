                ...
                <div class="table-responsive ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control m-b" name="type">
                                    ...
                                    <option <?php if($info['tag_type'] == $v['id']){echo 'selected';}?> value="<?php echo $v['id']?>" ><?php echo $v['name']?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="start" name="text" value="<?php echo $info['content']?>" minlength="2" type="text" class="form-control" valType="required" msg="标签内容不能为空" />
                            </div>
                        </div>
